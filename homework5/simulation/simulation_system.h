...
#include "homework5/simulation/single_thread_simulation_engine.h"
#include "homework5/simulation/system_base.h"
...
class SimulationSystem : public SystemBase {
 public:
  explicit SimulationSystem(const interface::homework5::SimulationConfig& simulation_config);
